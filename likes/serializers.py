...
class PostLikeSerializer(serializers.ModelSerializer):
    """
    Serializer which handles the representation and validation of `PostLike` instances.
    ...
    Methods:
        create(validated_data): Handles the creation of a new `PostLike` instance,
        and raises a validation error if a duplicate entry is detected.
    """
...
class CommentLikeSerializer(serializers.ModelSerializer):
    """
    Serializer which handles the representation and validation of `CommentLike` instances.
    ...
    Methods:
        create(validated_data): Handles the creation of a new `CommentLike` instance,
        and raises a validation error if a duplicate entry is detected.
    """
    owner = serializers.ReadOnlyField(source='owner.username')
