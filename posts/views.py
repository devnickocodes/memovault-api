...
class PostList(generics.ListCreateAPIView):
    ...
    - List all posts for authenticated users, with the ability to
                            filter, search, and order the results.
    ...
    Attributes:
        ...
        queryset (QuerySet): The queryset used to retrieve posts, annotated
                                  with comment and like counts, and ordered
                                  by creation date.
        filter_backends (list): Specifies the filter backends used for
                              filtering, searching, and ordering posts.
    ...
    Methods:
        perform_create: Associates the created post with the authenticated
                                                         user as the owner.
    """
...
class PostDetail(generics.RetrieveUpdateDestroyAPIView):
    ...
    - Update the details of a specific post if the requesting user is the
                                                        owner or an admin.
