...
class Post(models.Model):
    ...
    Attributes:
        ...
        updated_at (DateTimeField): The timestamp when the post was last
                                                                 updated.
    ...
    Meta:
        ordering (list): Orders records by the `created_at` field in
                                                    descending order.
    """
    ...
    image = models.ImageField(
        upload_to='images/', default='../post_placeholder_image_et5qsq',
        blank=True
    )
