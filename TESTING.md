...
* [Manual Testing](#manual-testing)
  * [Posts Endpoints](#posts-endpoints)
    - [/posts/ - GET](#posts-get)
    - [/posts/<id:int>/ - GET](#posts-idint-get)
    - [/posts/ - POST](#posts-post)
    - [/posts/<id:int>/ - PUT](#posts-idint-put)
    - [/posts/<id:int>/ - DELETE](#posts-idint-delete)
    - [/posts/<id:int>/ GET - 404 Not Found](#posts-idint-get-404-not-found)
  * [Comments Endpoints](#comments-endpoints)
    - [/comments/ - GET](#comments-get)
    - [/comments/<id:int>/ - GET](#comments-idint-get)
    - [/comments/ - POST](#comments-post)
    - [/comments/<id:int>/ - PUT](#comments-idint-put)
    - [/comments/<id:int>/ - DELETE](#comments-idint-delete)
    - [/comments/<id:int>/ GET - 404 Not Found](#comments-idint-get-404-not-found)
  * [Post Like Endpoints](#post-like-endpoints)
    - [/like/post/ GET](#like-post-get)
    - [/like/post/<id:int>/ GET](#like-post-idint-get)
    - [/like/post/ POST](#like-post-post)
    - [/like/post/<id:int>/ DELETE](#like-post-idint-delete)
    - [/like/post/<id:int>/ GET - 404 Not Found](#like-post-idint-get-404-not-found)
  * [Comment Like Endpoints](#comment-like-endpoints)
    - [/like/comment/ GET](#like-comment-get)
    - [/like/comment/<id:int>/ GET](#like-comment-idint-get)
    - [/like/comment/ POST](#like-comment-post)
    - [/like/comment/<id:int>/ DELETE](#like-comment-idint-delete)
    - [/like/comment/<id:int>/ GET - 404 Not Found](#like-comment-idint-get-404-not-found)
  * [Profiles Endpoints](#profiles-endpoints)
    - [/profiles/ - GET](#profiles-get)
    - [/profiles/<id:int>/ - GET](#profiles-idint-get)
    - [/profiles/ - POST - N/A](#profiles-post-na)
    - [/profiles/<id:int>/ - PUT](#profiles-idint-put)
    - [/profiles/<id:int>/ - DELETE](#profiles-idint-delete)
    - [/profiles/<id:int>/ GET - 404 Not Found](#profiles-idint-get-404-not-found)
  * [Reports Endpoints](#reports-endpoints)
    - [/reports/ - GET](#reports-get)
    - [/reports/<id:int>/ - GET](#reports-idint-get)
    - [/reports/<id:int>/ - POST](#reports-idint-post)
    - [/reports/<id:int>/ - PUT](#reports-idint-put)
    - [/reports/<id:int>/ - DELETE](#reports-idint-delete)
    - [/reports/admin/ GET](#reports-admin-get)
    - [/reports/admin/<id:int>/ - GET](#reports-admin-idint-get)
    - [/reports/admin/ POST - N/A](#reports-admin-post-na)
    - [/reports/admin/ PUT - N/A](#reports-admin-put-na)
    - [/reports/admin/<id:int>/ DELETE](#reports-admin-idint-delete)
* [Automated Testing](#automated-testing)
* [Python Validation](#python-validation)
  * [Comments App Python Validation](#comments-app-python-validation)
    - [admin.py](#adminpy)
    - [models.py](#models)
    - [serializers.py](#serializers)
    - [urls.py](#urls)
    - [views.py](#views)
  * [Followers App Python Validation](#followers-app-python-validation)
    - [admin.py](#adminpy-1)
    - [models.py](#models-1)
    - [serializers.py](#serializers-1)
    - [urls.py](#urls-1)
    - [views.py](#views-1)
  * [Likes App Python Validation](#likes-app-python-validation)
    - [admin.py](#adminpy-2)
    - [models.py](#models-2)
    - [serializers.py](#serializers-2)
    - [urls.py](#urls-2)
    - [views.py](#views-2)
  * [Memovault API Python Validation](#memovault-api-python-validation)
    - [permissions.py](#permissions)
    - [serializers.py](#serializers-3)
    - [settings.py](#settings)
    - [urls.py](#urls-3)
    - [views.py](#views-3)
  * [Posts App Python Validation](#posts-app-python-validation)
    - [admin.py](#adminpy-3)
    - [models.py](#models-3)
    - [serializers.py](#serializers-4)
    - [urls.py](#urls-4)
    - [views.py](#views-4)
  * [Profiles App Python Validation](#profiles-app-python-validation)
    - [admin.py](#adminpy-4)
    - [models.py](#models-4)
    - [serializers.py](#serializers-5)
    - [urls.py](#urls-5)
    - [views.py](#views-5)
  * [Reports App Python Validation](#reports-app-python-validation)
    - [admin.py](#adminpy-5)
    - [models.py](#models-5)
    - [serializers.py](#serializers-6)
    - [tests.py](#tests)
    - [urls.py](#urls-6)
    - [views.py](#views-6)
...
![Profiles App - admin.py](https://github.com/devnickocodes/memovault-api/blob/main/testing_docs/profiles_admin.py_validation.png)

#### models.py

![Profiles App - models.py](https://github.com/devnickocodes/memovault-api/blob/main/testing_docs/profiles_models.py_validation.png)

#### serializers.py

![Profiles App - serializers.py](https://github.com/devnickocodes/memovault-api/blob/main/testing_docs/profiles_serializers.py_validation.png)

#### urls.py

![Profiles App - urls.py](https://github.com/devnickocodes/memovault-api/blob/main/testing_docs/profiles_urls.py_validation.png)
